...
-(void)initFstSceneEnemy:(b2World *)world
{
    enemies = [[CCArray alloc] initWithCapacity:1];
    ...
    firstEnemyParam.spriteFrameName = @"candystick.png";
...
-(void)initScdSceneEnemy:(b2World *)world
{
    ...
    secondEnemyParam.initialHitPoints = 3;
    //firstEnemyParam.radius = 1;
    ...
    secondEnemyParam.spriteFrameName = @"redcross.png";
