...
//    temCapacity = [[GameMainScene sharedMainScene] roleParamArray][[[GameMainScene sharedMainScene] roleType] - 1].storageCapacity + temCapacity;
    int temCapacity = [[CommonLayer sharedCommonLayer] getRoleParam:[[GameMainScene sharedMainScene]roleType] ParamType:STORAGECAPACITY];
...
//    temCapacityPlay2 = [[GameMainScene sharedMainScene] roleParamArray][0].storageCapacity + temCapacityPlay2;
    int temCapacityPlay1 = [[CommonLayer sharedCommonLayer] getRoleParam:1 ParamType:STORAGECAPACITY];
    int temCapacityPlay2 = [[CommonLayer sharedCommonLayer] getRoleParam:2 ParamType:STORAGECAPACITY];
